...
# Legend Crown?
# make planeswalker en dashes thicker
# historically accurate set symbols?
# AI boomerification of rules text?
# boomer mdfc text
# old basic land watermarks
# color grading options (darker white cards, faded cards, more violet blue cards)
...
class RetroTemplate(NormalTemplate):
    ...
    def is_tombstone_auto(self) -> bool:
        for keyword in tombstone_keyword_list:
